...
class ModelProfile {
  ...
  ModelProfile copyWith({
    ...
    return ModelProfile(
      ...
      topFan: topFan ?? this.topFan,
      pricePerMin: pricePerMin ?? this.pricePerMin,
      isOnline: isOnline ?? this.isOnline,
      isVerified: isVerified ?? this.isVerified,
      isFollowed: isFollowed ?? this.isFollowed,
      hasExtraGems: hasExtraGems ?? this.hasExtraGems,
      customBadge: customBadge ?? this.customBadge,
      closeFriendsStatus: closeFriendsStatus ?? this.closeFriendsStatus,
      ...
      iLikeCount: iLikeCount ?? this.iLikeCount,
      likeMeCount: likeMeCount ?? this.likeMeCount,
      coins: coins ?? this.coins,
      beans: beans ?? this.beans,
      isLive: isLive ?? this.isLive,
      activeLiveStreamId: activeLiveStreamId ?? this.activeLiveStreamId,
      liveChannelName: liveChannelName ?? this.liveChannelName,
    );
  }
